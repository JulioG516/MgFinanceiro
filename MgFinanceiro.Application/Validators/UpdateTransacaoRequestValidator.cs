...
public class UpdateTransacaoRequestValidator : AbstractValidator<UpdateTransacaoRequest>
{
    public UpdateTransacaoRequestValidator()
    {
        RuleFor(t => t.Id)
            .GreaterThan(0).WithMessage("O ID da transação é obrigatório.");
